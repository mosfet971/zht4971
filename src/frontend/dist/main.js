...
`,rv=fn.div`
  ...
  z-index: 1;
`;const ov=Dt(()=>{let n=[];return n.push(g.createElement(rv,null)),Du.isLogined?n.push(g.createElement(jg,null)):n.push(g.createElement(qg,null)),We.isOpened&&n.push(g.createElement(Zh,null)),g.createElement(nv,{style:{color:b0.WHITE,background:b0.DARK_GRAY2},className:"bp5-dark"},g.createElement(fh,null,n))});T.render(g.createElement(ov,null),document.getElementById("reactRoot"))})()})();})();
