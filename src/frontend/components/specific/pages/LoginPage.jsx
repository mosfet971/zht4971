    ...
    <Container>
      <LoginForm className="bp5-card bp5-elevation-4">
        <div>
          ...
          <p>
          Если база данных ещё не создана, она будет инициализирована с указанным паролем. Рекомендуется использовать данную программу только в безопасном окружении и с отключенным файлом подкачки.
          </p>
